 ...
 * @author Sejran
 */
public class Reply3visitor extends javax.swing.JFrame {

    QA qa;
    JFrame parent;

    public Reply3visitor(JFrame p, QA qa) {
        initComponents();
         this.parent = p;
        this.qa = qa;
    ...
    private void initComponents() {
        ...
        jLabel2.setBackground(new java.awt.Color(218, 104, 104));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pse/back2.png"))); // NOI18N
        ...
        jButton1.setBounds(10, 410, 60, 61);
