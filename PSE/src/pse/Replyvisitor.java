 ...
 * @author Sejran
 */
public class Replyvisitor extends javax.swing.JFrame {
    QA qa;
    JFrame parent;

    public Replyvisitor(JFrame p, QA qa) {
        initComponents();
        this.parent = p;
        this.qa = qa;
    ...
    private void initComponents() {
        ...
        jScrollPane3.setBounds(330, 170, 340, 160);

        jTextArea1.setEditable(false);
        jTextArea1.setBackground(new java.awt.Color(37, 151, 151));
        ...
        jScrollPane1.setBounds(330, 40, 340, 110);
        ...
        jButton1.setBounds(20, 180, 260, 37);
        ...
        jButton2.setBounds(10, 500, 60, 60);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reply3visitor(Replyvisitor.this, qa).setVisible(true);
            }
        });
...
//            
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "You have to regiser to answer these questions!!!","Erorr", JOptionPane.ERROR_MESSAGE);
